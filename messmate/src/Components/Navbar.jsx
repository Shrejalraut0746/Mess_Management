...
const Navbar = () => {
  ...
  return (
    <header className="text-gray-900 body-font">
      <div className="container m-auto my-2 flex flex-wrap mt-2 max-w-[90%] rounded-2xl  mb-4 min-h-[10vh] bg-gradient-to-r from-[#020024] from-0% via-green-800 via-50%   to-lime-400 to-90%  flex-col md:flex-row items-center">
        <Link
          to="/"
