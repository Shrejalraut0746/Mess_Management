...
function Alluser() {
  ...
  const pagesArray = Array(totalpages)
    ...
    .map((index, i) => {
      return (
        <button
          className="relative hidden items-center px-4 py-2 text-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 md:inline-flex"
          onClick={() => {
            setPage(i);
